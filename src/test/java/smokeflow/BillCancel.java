...
public class BillCancel extends MainClass{
	...
	@Test(description = "Bill_Cancel", priority = 5, enabled = true)
	public void BillCancel() throws Exception {
		logger = extent.startTest("BillCancel");
		BillingObject itemobj=new BillingObject(driver,logger);
		itemobj.bill_cancel(billNumber);
	} 
